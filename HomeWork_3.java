...
public class HomeWork_3 {
    ...
    */
    static List<Integer> sort(List<Integer> list){
        ...
        // рекурсией от поделенных обеих частей вызываем метод sort, 
        // пока не дойдем до одного элемента в массиве,
        left = sort(left); 
        right = sort(right);

        // и затем рекурсивно слияем два отсортированных массива
